            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                _buildSection('About Me', Icons.person_outline_rounded, [
                  ...
                  _InfoRow(
                    'About',
                    'A passionate software engineer who loves music, travel and good food. Looking for a life partner with similar values and a caring heart.',
                    multiline: true,
                  ),
                ]),
                ...
                _buildSection('Lifestyle', Icons.self_improvement_rounded, [
                  ...
                  _InfoRow(
                    'Hobbies',
                    'Classical music, Trekking, Cooking, Reading',
                  ),
                ...
                _buildSection(
                  ...
                  [
                    _InfoRow(
                      'Expectation',
                      'Looking for someone who is caring, family-oriented and respects cultural values. Must love travel and have a good sense of humour. Open to working couples.',
                      multiline: true,
                    ),
                  ],
                ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: AppColors.gradRoseGold,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFFFFF5EC), Color(0xFFFFF8F0)],
        ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Add hobbies & photos to get 3x more views!',
                  style: TextStyle(
                    fontSize: 12,
